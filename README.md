...
The server application will remain installed on the HoloLens even after power off and you can find it in the All apps list. The Unity plugin is in the hl2ss\ARM64\Release\plugin folder.
