...
- [MARCuS](https://github.com/jdibenes/marcus): Interactive Rubik's Cube Solver for HoloLens 2 using Unity and MRTK.
- [hl2flo](https://github.com/jdibenes/hl2flo): Create optical flow datasets using HoloLens 2.
