...
#ifndef _FAST_DDS_GENERATED_BUILTIN_INTERFACES_MSG_DURATION__H_
#define _FAST_DDS_GENERATED_BUILTIN_INTERFACES_MSG_DURATION__H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(Duration__SOURCE)
#define Duration__DllAPI __declspec( dllexport )
#else
#define Duration__DllAPI __declspec( dllimport )
#endif // Duration__SOURCE
#else
#define Duration__DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define Duration__DllAPI
#endif // _WIN32
...
#endif // _FAST_DDS_GENERATED_BUILTIN_INTERFACES_MSG_DURATION__H_