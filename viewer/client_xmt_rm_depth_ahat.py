...
configuration = hl2ss_mt.create_configuration(hl2ss.StreamPort.RM_DEPTH_AHAT)
configuration['mode'] = mode
configuration['divisor'] = divisor
configuration['profile_z'] = profile_z
configuration['profile_ab'] = profile_ab
configuration['bitrate'] = bitrate

client = hl2ss_mt.rx_decoded_rm_depth_ahat(host, hl2ss.StreamPort.RM_DEPTH_AHAT, buffer_size * hl2ss.Parameters_RM_DEPTH_AHAT.FPS, configuration)
client.open()
