...
configuration = hl2ss_mt.create_configuration(hl2ss.StreamPort.EXTENDED_VIDEO)
...
client = hl2ss_mt.rx_decoded_pv(host, hl2ss.StreamPort.EXTENDED_VIDEO, buffer_size * framerate, configuration)
client.open()
