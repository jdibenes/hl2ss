...
configuration = hl2ss_mt.create_configuration(hl2ss.StreamPort.EXTENDED_AUDIO)
configuration['mixer_mode'] = hl2ss.extended_audio_device_mixer_mode(mixer_mode, source_index)
configuration['profile'] = profile

client = hl2ss_mt.rx_decoded_extended_audio(host, hl2ss.StreamPort.EXTENDED_AUDIO, buffer_size, configuration)
client.open()
