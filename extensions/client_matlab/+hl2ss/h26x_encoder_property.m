...
properties (Constant)
    ...
    HL2SSAPI_VideoMediaIndex                = uint64(0xFFFFFFFFFFFFFFFB);
    HL2SSAPI_VideoStrideMask                = uint64(0xFFFFFFFFFFFFFFFC);
    HL2SSAPI_AcquisitionMode                = uint64(0xFFFFFFFFFFFFFFFD);
